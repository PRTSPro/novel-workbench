  ...
  apply(ctx) {
    ...
    function Workbench() {
      ...
      if (!data) {
        ...
        content = h('div', { style: { display: 'flex', alignItems: 'stretch', minHeight: 460 } },
          h('div', { style: { flex: '0 0 280px', borderRight: '1px solid ' + ST.line, padding: '12px 14px', background: ST.colBg, maxHeight: '72vh', overflowY: 'auto' } },
          ...
          h('div', { style: { flex: '1 1 auto', minWidth: 0, padding: '12px 14px', maxHeight: '72vh', overflowY: 'auto' } },
            middle),
          h('div', { style: { flex: '0 0 320px', borderLeft: '1px solid ' + ST.line, padding: '12px 14px', background: ST.colBg, maxHeight: '72vh', overflowY: 'auto' } },
      ...
      const header = h('div', { style: { display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10, flexWrap: 'wrap' } },
        h('span', { style: { fontSize: 16, fontWeight: 700, color: ST.text } }, data ? '《' + data.meta.title + '》推演台' : '推演台'),
    ...
    slots.inject('conversation.view', function () {
      return slots.register(
        { name: 'conversation.view', id: 'novel-workbench', order: 20, label: '推演台' },
